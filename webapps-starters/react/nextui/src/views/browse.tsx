...
export default function Browse() {
    ...
    async function fetchComponents() {
        const response = await fetch(
            `https://api.ui.bacopilot.site/components/list?framework=react&components=nextui&icons=lucide`
        );
    ...
    const newComponent = async () => {
        ...
        const response = await fetch(
            `https://api.ui.bacopilot.site/components/new/${generateMode}`,
            {
                method: "POST",
                headers: {
            ...
            <div className="min-h-screen min-h-screen overflow-y-auto antialiased">
                <div className={!processing ? "" : 'opacity-20'}>
				    ...
				    grid sm:flex items-center space-x-2 xl:space-x-4 space-y-1 z-50">
                        ...
                        {/*<div>*/}
                        {/*    {generateMode === 'json' ? (*/}
                        {/*        <a href="#" onClick={() => setGenerateMode('description')} id="mode_json"*/}
                        ...
                        {/*                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#3a3a3a"*/}
                        {/*                     viewBox="0 0 24 24">*/}
                        {/*                    <path*/}
                        ...
                        {/*        </a>*/}
                        {/*    ) : (*/}
                        {/*        <a href="#" onClick={() => setGenerateMode('json')} id="mode_description"*/}
                        {/*           className="hidden sm:block md:-ml-10">*/}
                        {/*            <div className="rounded rounded-full shadow shadow-md dark:shadow-[#111]*/}
				        {/*    text-center p-4 text-center*/}
				        {/*    bg-[#ddd] hover:bg-white*/}
                        ...
                        <div
                            className="sm:w-full rounded rounded-xl p-2 flex items-center text-xl duration-200 shadow shadow-lg dark:shadow-[#090909] bg-[#ddd] dark:bg-[#222] dark:text-white">
                        ...
                        <div className="sm:mx-4 duration-200">
                            ...
                            >
                                <svg height="30" width="30" version="1.1" id="Layer_1"
                                     xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                                     viewBox="0 0 512 512" xmlSpace="preserve" fill="#777">
                    ...
                    {openv0ComponentsList.length || componentStream ? (
                        <div className="p-2 rounded grid sm:grid-cols-2 xl:grid-cols-3 items-start">
                            ...
                            {loadedComponents.map((component, index) => (
                                ...
                                <a href={`/view/${component.name}`} key={index}
                                   className="m-1 hover:m-2 duration-200 cursor-pointer">
                                    <div className="p-2 rounded rounded-md">
                                        ...
                                        <div
                                            className="my-2 bg-white dark:bg-[#222] dark:text-white p-4 text-sm max-h-52 max-w-32 overflow-hidden">
                            ...
                            {componentStream && (
                                <div className="m-1 hover:m-2 duration-200 cursor-pointer opacity-70">
                                    <div className="p-2 rounded rounded-md">
                                        ...
                                        <div
                                            className="my-2 bg-white dark:bg-[#222] dark:text-white p-4 text-xs max-h-52 max-w-32 overflow-hidden whitespace-pre-wrap break-words font-mono">
                                            {componentStream}
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div
                            className="max-w-5xl py-52 mx-auto text-center text-7xl opacity-30 text-[#777] break-words font-bold">
                            UI Generation
                        </div>
                    )}
